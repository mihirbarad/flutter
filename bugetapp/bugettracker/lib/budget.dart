...
class add_budget extends StatefulWidget {
  ...
  @override
  State<add_budget> createState() => _Add_listexpenceState();
}

class _Add_listexpenceState extends State<add_budget> {
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  PageTransition(
                    ...
                    child: home(budget: BudgetController.text.toString()),
                  ),
                );
                print('Pressed');
              },
